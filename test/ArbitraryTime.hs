{-- Retrieved from https://hackage.haskell.org/package/time-1.9/src/test/main/Test/Arbitrary.hs --}
{-- Used for generating random dates for QuickCheck --}

{-# OPTIONS -fno-warn-orphans #-}

module ArbitraryTime where
